...
func TestValidDefaultValue(t *testing.T) {
	testCases := []DefaultTypeTestCase{
		{Type: TypeString, Value: "foo"},
		{Type: TypeInteger, Value: 123},
		{Type: TypeBool, Value: false},
		{Type: TypeDate, Value: "2018-01-01"},
		{Type: TypeStringList, Value: []string{"foo", "bar"}},
		{Type: TypeIntegerList, Value: []int{1, 2, 3}},
		{Type: TypeStringList, Value: []string{}},
		{Type: TypeIntegerList, Value: []int{}},
		{Type: TypeChoice, Value: "foo", Choices: []string{"foo", "bar"}},
		{Type: TypeChoiceList, Value: []string{"foo", "bar"}, Choices: []string{"foo", "bar"}},
	}
	for _, testCase := range testCases {
