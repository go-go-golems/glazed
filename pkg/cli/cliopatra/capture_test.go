...
func TestSingleFlag(t *testing.T) {
	...
	assert.Equal(t, "test", p.Flags[0].Flag)
...
func TestTwoFlags(t *testing.T) {
	...
	assert.Equal(t, "test2", p.Flags[1].Flag)
...
func TestSingleArg(t *testing.T) {
	...
	assert.Equal(t, "test", p.Args[0].Flag)
...
func TestTwoArgsTwoFlags(t *testing.T) {
	...
	assert.Equal(t, "test2", p.Args[1].Flag)
